...
if($_POST)
{
	$to_Email   	= "felipevegaaraujo@gmail.com"; //Replace with recipient email address
	$subject        = 'Ah!! Mail from Discovery Tubulars'; //Subject line for emails
	...
	if(strlen($user_Message)<4) //check emtpy message
	{
	...
	if(!$sentMail)
	{
		...
		$output = json_encode(array('type'=>'message', 'text' => 'Hi '.$user_Name .' Thank you for your email. We will get back to you soon.'));
		die($output);
	}
}
?>